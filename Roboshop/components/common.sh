...
SETUP_SYSTEMD() {
  ...
  sed -i -e 's/MONGO_DNSNAME/mongodb.ansible/' -e 's/REDIS_ENDPOINT/redis.ansible/' -e 's/MONGO_ENDPOINT/mongodb.ansible/' /home/Roboshop/$1/systemd.service && mv /home/Roboshop/$1/systemd.service /etc/systemd/system/$1.service
  STAT $?
